...
This is a client-rendered React SPA deployed as static assets through Cloudflare Workers. The Wrangler configuration points at `dist/` and enables SPA fallback so direct loads of `/blog`, `/blog/:slug`, and `/resources/:slug` resolve through the client router.
